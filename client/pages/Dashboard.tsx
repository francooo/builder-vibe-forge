    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Visão geral do CRM de licenciamento ambiental
          </p>
        </div>
      ...
      <div className="grid gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
        <Metric
          ...
          value="42"
          trend="+5%"
          className="bg-gradient-to-br from-emerald-50 to-transparent dark:from-emerald-950/30"
        />
        <Metric
          title="Próximos Prazos (30d)"
          value="18"
          trend="+2"
          className="bg-gradient-to-br from-amber-50 to-transparent dark:from-amber-950/30"
        />
        <Metric
          title="Em Análise"
          value="27"
          trend="-3"
          className="bg-gradient-to-br from-cyan-50 to-transparent dark:from-cyan-950/30"
        />
        <Metric
          title="Em Atraso"
          value="6"
          trend="+1"
          className="bg-gradient-to-br from-rose-50 to-transparent dark:from-rose-950/30"
        />
      </div>
